package com.teamclicker.notificationservice.validators;

import com.teamclicker.notificationservice.security.RoleType
...
annotation class ValidateRoles(
    val message: String = "{com.teamclicker.notificationservice.validators.ValidateRoles.message}",
